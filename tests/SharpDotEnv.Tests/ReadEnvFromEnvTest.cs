...
namespace SharpDotEnv.Tests
{
    ...
    {
        private readonly DotEnv fileEnv = DotEnv.ParseFile(Path.Combine(Directory.GetCurrentDirectory(), ".env-test"), Encoding.UTF8);
        private readonly DotEnv streamEnv = DotEnv.Parse(File.OpenRead(Path.Combine(Directory.GetCurrentDirectory(), ".env-test")), Encoding.UTF8);
        ...
        public readonly static TheoryData<string, string> ParseCases = new TheoryData<string, string>()
        {
