...
namespace SharpDotEnv.Tests
{
    ...
    {
        public static readonly TheoryData<string, TestToken[]> WithCommentsAndWhitespace = new TheoryData<string, TestToken[]>()
        {
        ...
        ", new TestToken[]
            {
                ...
                new TestToken(TokenType.Whitespace, Environment.NewLine + Environment.NewLine + "    "),
        ...
        ", new TestToken[]
            {
                ...
                new TestToken(TokenType.Equals, "="),
                new TestToken(TokenType.Whitespace, "   "),
                new TestToken(TokenType.Value, "leading whitespace    and  trailing    whitespace is ignored"),
                new TestToken(TokenType.Whitespace, "   "),
